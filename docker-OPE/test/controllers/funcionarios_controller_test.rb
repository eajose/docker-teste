...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { Codigo: @funcionario.Codigo, Departamento: @funcionario.Departamento, Nome: @funcionario.Nome } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { Codigo: @funcionario.Codigo, Departamento: @funcionario.Departamento, Nome: @funcionario.Nome } }
