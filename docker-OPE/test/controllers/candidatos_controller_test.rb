...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference('Candidato.count') do
      post candidatos_url, params: { candidato: { CPF: @candidato.CPF, Login: @candidato.Login, Senha: @candidato.Senha } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { CPF: @candidato.CPF, Login: @candidato.Login, Senha: @candidato.Senha } }
